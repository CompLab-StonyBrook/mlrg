...
Continuous transductions are a method to lift certain classes of languages to classes of string-to-string functions that has not been explored from a linguistic perspective yet. 
